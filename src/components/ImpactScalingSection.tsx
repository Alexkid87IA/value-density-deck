...
/**
 * ImpactScalingSection — Component ajusté pour 300k€
 * 
 * Montre l'impact du financement de 300k€ vs scénario de base
 */
...
export default function ImpactScalingSection() {
  ...
  // Scenarios ajustés pour 300k€
  const data = {
    base: {
      label: "Sans financement",
      capex: 0,
      mrr12: 25, // k€ MRR @12m - scénario bootstrap
      users: 30_000,
      cac: 18, // € - coût d'acquisition plus élevé sans budget
      payback: 9, // months
      runway: 3, // months - très court sans financement
      impressions: 12, // M / month @12m
    },
    plus: {
      label: "+300k€ maintenant",
      capex: 300,
      mrr12: 46, // k€ MRR @12m - objectif réaliste avec 300k€
      users: 120_000,
      cac: 8, // € - optimisé avec budget
      payback: 4,
      runway: 15, // months - 12-15 mois avec 300k€
      impressions: 30,
    },
  } as const;
  ...
  // Fund allocation adaptée à 300k€
  const allocation = [
    { label: "Acquisition & Growth", value: 35 },
    { label: "Produit & Tech (IA, automatisation)", value: 30 },
    { label: "Équipe (6-8 personnes)", value: 25 },
    { label: "Opérations & Infrastructure", value: 10 },
  ];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8">
        ...
        >
          ...
          <p className="mt-4 text-white/60 max-w-3xl font-light text-lg md:text-xl">
            Ce que <span className="text-white/80">300k€ de financement</span> débloque dans les 12 prochains mois —
            comparé au scénario bootstrap.
          </p>
        </div>
          ...
          <div className="relative h-28 bg-white/[0.02] rounded-lg overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0">
              <div
                ...
                title={`${data.plus.impressions}M avec +300k€`}
              />
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div>
            ...
            <p className="mt-3 text-xs text-white/40">
              Déblocage progressif sur 12 mois, milestones mensuelles.
            </p>
          </div>
              ...
              <table className="w-full text-sm">
                <thead className="bg-white/[0.03] text-white/60">
                  <tr>
                    ...
                    <th className="text-left py-3 px-4 font-light">Bootstrap</th>
                    <th className="text-left py-3 px-4 font-light">+300k€</th>
                  </tr>
                </thead>
                <tbody className="text-white/70">
                  <tr className="border-t border-white/5">
                    ...
                    <td className="py-3 px-4 text-green-400/80">{data.plus.mrr12}k€</td>
                  </tr>
                  <tr className="border-t border-white/5">
                    <td className="py-3 px-4">Utilisateurs</td>
                    <td className="py-3 px-4">{k(data.base.users)}</td>
                    <td className="py-3 px-4 text-green-400/80">{k(data.plus.users)}</td>
                  </tr>
                  <tr className="border-t border-white/5">
                    <td className="py-3 px-4">CAC</td>
                    <td className="py-3 px-4">{data.base.cac}€</td>
                    <td className="py-3 px-4 text-green-400/80">{data.plus.cac}€</td>
                  </tr>
                  <tr className="border-t border-white/5">
                    <td className="py-3 px-4">Payback</td>
                    <td className="py-3 px-4">{data.base.payback} mois</td>
                    <td className="py-3 px-4 text-green-400/80">{data.plus.payback} mois</td>
                  </tr>
                  <tr className="border-t border-white/5">
                    <td className="py-3 px-4">Runway</td>
                    <td className="py-3 px-4">{data.base.runway} mois</td>
                    <td className="py-3 px-4 text-green-400/80">{data.plus.runway} mois</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {/* Milestones avec 300k€ */}
        <div className="mb-16">
          <h3 className="text-sm font-light text-white/40 mb-6 tracking-[0.2em]">
            MILESTONES CLÉS AVEC 300K€
          </h3>
            ...
            {[
              {
                ...
                title: "Foundation",
                items: [
                  "Équipe core de 6 personnes",
                  "Infrastructure IA en place",
                  "10k€ MRR atteint"
                ]
              },
              {
              ...
              <div key={i} className="p-6 rounded-lg bg-white/[0.02] border border-white/[0.06]">
                <div className="text-xs text-white/40 mb-2">{milestone.month}</div>
                <h4 className="text-lg text-white/80 mb-4">{milestone.title}</h4>
                <ul className="space-y-2">
                  {milestone.items.map((item, j) => (
                    <li key={j} className="flex items-start gap-2">
                      <span className="text-electric-cyan/60 mt-1">•</span>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {[
            {
              t: "Traction prouvée",
              d: "120k followers actifs, 10M reach/mois, pipeline brand content établi.",
            },
            {
              t: "Modèle diversifié",
              d: "3 sources de revenus : Brand content (28k€), Newsletter (10k€), RS (8k€).",
            },
            {
              t: "Équipe expérimentée",
              d: "Roger Feddag + équipe tech/créa rodée, process industrialisés.",
            },
          ].map((b, i) => (
            <div
              key={i}
          ...
          <button className="group relative overflow-hidden">
            <div className="relative px-12 py-5">
              ...
              <span className="relative z-10 text-white/90 font-light tracking-wide flex items-center gap-3">
                ...
                <span>Accélérer avec 300k€ : recevoir le deck complet</span>
              </span>
            </div>
          </button>
          <p className="mt-3 text-xs text-white/40">Projections détaillées, use of funds, et roadmap 18 mois inclus.</p>
        </div>
      </div>
